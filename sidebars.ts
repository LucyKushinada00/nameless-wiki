          ...
          items: [
            {
              ...
              items: [
                ...
                "getting-started/downloads/oneplus/dodge",
              ],
            },
            {
              type: "category",
              ...
              items: ["getting-started/downloads/nothing/pong"],
            },
            {
              type: "category",
              ...
              link: {
                ...
                description:
                  "Legacy Devices are marked as EoL and would no longer recieving updates. No bug reports will be accepted for these devices.",
          ...
          items: [
            {
              ...
              items: [
                ...
                "getting-started/flash-instructions/oneplus/dodge",
              ],
            },
            {
              type: "category",
              ...
              items: ["getting-started/flash-instructions/nothing/pong"],
            },
            {
              type: "category",
              label: "Legacy Devices (EoL)",
