...
- Nameless ROM Image ([Download Here](/docs/getting-started/downloads/oneplus/lemonadep.md))
...
:::info
    ...
    2. If you get the error `Error Applying update: 7 (ErrorCode: kInstallDeviceOpenError)` while flashing the ROM, flash the [super-empty.img](/docs/getting-started/downloads/oneplus/lemonadep.md#nameless-15) from fastboot mode using `fastboot wipe-super super_empty.img` before sideloading the ROM again.
:::
