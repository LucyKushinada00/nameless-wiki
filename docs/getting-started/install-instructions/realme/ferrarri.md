...
- LineageOS Recovery ([Download here](https://github.com/pjgowtham/android_device_realme_ferrarri))
- Nameless AOSP ROM Image ([Download here](/docs/getting-started/downloads/ferrarri.md))
