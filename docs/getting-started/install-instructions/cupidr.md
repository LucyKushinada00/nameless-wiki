...
- LineageOS Recovery ([Download here](https://github.com/pjgowtham/android_device_realme_cupidr))
- Nameless AOSP ROM Image ([Download here](/docs/getting-started/downloads/cupidr.md))
